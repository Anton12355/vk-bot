<body>
<a href="<?php echo 'http://' . $_SERVER['HTTP_HOST']; ?>/vk-bot?action=get_users&user_ids=17439143,763899,1">Users</a>
<a href="<?php echo 'http://' . $_SERVER['HTTP_HOST']; ?>/vk-bot?user_ids=763897&action=get_friends&page=2">Friends</a>
<a href="<?php echo 'http://' . $_SERVER['HTTP_HOST']; ?>/vk-bot?user_ids=763897&action=get_wall">Wall</a>
